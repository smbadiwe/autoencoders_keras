    ...
    def __init__(self,
        ...
        for i in range(self.encoder_layers):
            if i == 0:
                ...
                self.encoded = keras.layers.Conv1D(filters=self.filters, kernel_size=self.kernel_size,
                                                   strides=self.strides, activation="elu", padding="same")(self.encoded)
        ...
        self.encoded = BatchNormalization()(self.encoded)
        self.encoded = keras.layers.Conv1D(filters=self.filters, kernel_size=self.kernel_size, strides=self.strides,
                                           activation="elu", padding="same")(self.encoded)
        ...
        for i in range(self.decoder_layers):
            if i < self.decoder_layers - 1:
                ...
                self.decoded = keras.layers.Conv1D(filters=self.filters, kernel_size=self.kernel_size,
                                                   strides=self.strides, activation="elu", padding="same")(self.decoded)
        ...
        self.decoded = BatchNormalization()(self.decoded)
        self.decoded = keras.layers.Conv1D(filters=self.input_shape[1], kernel_size=self.kernel_size,
                                           strides=self.strides, activation="sigmoid", padding="same")(self.decoded)
